import { Bike, Dumbbell, Tent, Trophy, Volleyball, Waves } from "lucide-react";

const categories = [
  {
    title: "Football",
    description: "Boots, balls, gloves & more",
    icon: Trophy,
  },
  {
    title: "Camping",
    description: "Tents, sleeping bags, cooking kits",
    icon: Tent,
  },
  {
    title: "Gym",
    description: "Weights & fitness equipment",
    icon: Dumbbell,
  },
  {
    title: "Cycling",
    description: "Bikes & safety gear",
    icon: Bike,
  },
  {
    title: "Volleyball",
    description: "Nets, balls & accessories",
    icon: Volleyball,
  },
  {
    title: "Water Sports",
    description: "Kayaks, surfboards & more",
    icon: Waves,
  },
];
